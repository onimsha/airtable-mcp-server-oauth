...
from mcp_oauth_lib import MCPOAuthServer, OAuthConfig, AuthContext
from mcp_oauth_lib.providers.airtable import AirtableOAuthProvider, AirtableProviderConfig
...
class AirtableMCPServer:
    ...
    def __init__(
        ...
        self.oauth_server: Optional[MCPOAuthServer] = None
    ...
    def _initialize_oauth_server(self) -> None:
        ...
        try:
            ...
            redirect_uri = os.getenv("AIRTABLE_REDIRECT_URI", "http://localhost:8000/auth/callback")
            scope = os.getenv("AIRTABLE_SCOPE", "data.records:read data.records:write data.recordComments:read data.recordComments:write schema.bases:read schema.bases:write webhook:manage")
    ...
    def _get_oauth_provider(self) -> Optional[AirtableOAuthProvider]:
    ...
    def _register_tools(self) -> None:
        ...
        async def list_tables(
            ...
            detail_level: Annotated[Literal["tableIdentifiersOnly", "withFieldInfo"], Field(
        ...
        async def list_records(
            base_id: Annotated[str, Field(description="The Airtable base ID")],
            table_id: Annotated[str, Field(description="The table ID or name")],
            view: Annotated[Optional[str], Field(description="View name or ID")] = None,
            filter_by_formula: Annotated[Optional[str], Field(description="Airtable formula for filtering")] = None,
            sort: Annotated[Optional[List[Dict[str, str]]], Field(description="Sort configuration - array of {field: string, direction: 'asc'|'desc'}")] = None,
            fields: Annotated[Optional[Union[str, List[str]]], Field(description="Specific fields to include (field name or array of field names)")] = None
        ) -> List[Dict[str, Any]]:
        ...
        async def create_record(
            ...
            typecast: Annotated[bool, Field(description="Enable automatic data conversion")] = False
        ) -> Dict[str, Any]:
        ...
        async def create_records(
            base_id: Annotated[str, Field(description="The Airtable base ID")],
            table_id: Annotated[str, Field(description="The table ID or name")],
            records: Annotated[List[Dict[str, Any]], Field(description="List of records to create")],
            typecast: Annotated[bool, Field(description="Enable automatic data conversion")] = False
        ) -> List[Dict[str, Any]]:
        ...
        async def update_records(
            base_id: Annotated[str, Field(description="The Airtable base ID")],
            table_id: Annotated[str, Field(description="The table ID or name")],
            records: Annotated[List[Dict[str, Any]], Field(description="List of record updates")],
            typecast: Annotated[bool, Field(description="Enable automatic data conversion")] = False
        ) -> List[Dict[str, Any]]:
        ...
        async def delete_records(
            base_id: Annotated[str, Field(description="The Airtable base ID")],
            table_id: Annotated[str, Field(description="The table ID or name")],
            record_ids: Annotated[List[str], Field(description="List of record IDs to delete")]
        ) -> List[str]:
        ...
        async def search_records(
            base_id: Annotated[str, Field(description="The Airtable base ID")],
            table_id: Annotated[str, Field(description="The table ID or name")],
            filter_by_formula: Annotated[str, Field(description="Airtable formula for filtering")],
            view: Annotated[Optional[str], Field(description="View name or ID")] = None,
            fields: Annotated[Optional[Union[str, List[str]]], Field(description="Specific fields to include (field name or array of field names)")] = None
        ) -> List[Dict[str, Any]]:
    ...
    async def _get_authenticated_client(self) -> AirtableClient:
        ...
        try:
            ...
            if not provider:
                raise AirtableAuthError("OAuth provider not available - ensure OAuth endpoints are enabled and credentials are configured")
    ...
    def run(self, transport: str = "stdio", host: str = "0.0.0.0", port: int = 8000, **kwargs) -> None:
        ...
        if transport.lower() == "http":
            logger.info(f"HTTP server will be available at: http://{self.server_host}:{port}")
            ...
            if self.enable_oauth_endpoints and self.oauth_server:
                ...
                middleware.append((OAuthAuthenticationMiddleware, [], {"oauth_base_url": f"http://{self.server_host}:{port}"}))
