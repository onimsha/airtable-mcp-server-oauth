...
class TestTokenManager:
    ...
    async def test_save_tokens_success(self, mock_firestore_client):
        ...
        mock_firestore_client.collection.assert_called_once_with("airtable_oauth_tokens")
        mock_firestore_client.collection.return_value.document.assert_called_once_with("user123")
    ...
    async def test_save_tokens_google_cloud_error(self, mock_firestore_client):
        ...
        mock_firestore_client.collection.return_value.document.return_value.set.side_effect = GoogleCloudError("Firestore error")
    ...
    async def test_save_tokens_general_error(self, mock_firestore_client):
        ...
        # Mock general error
        mock_firestore_client.collection.return_value.document.return_value.set.side_effect = Exception("General error")
    ...
    async def test_load_tokens_google_cloud_error(self, mock_firestore_client):
        ...
        # Mock Firestore error
        mock_firestore_client.collection.return_value.document.return_value.get.side_effect = GoogleCloudError("Firestore error")
    ...
    @pytest.mark.asyncio
    async def test_create_oauth_handler_with_existing_tokens(self, mock_firestore_client):
    ...
    async def test_delete_tokens_google_cloud_error(self, mock_firestore_client):
        ...
        # Mock Firestore error
        mock_firestore_client.collection.return_value.document.return_value.delete.side_effect = GoogleCloudError("Firestore error")
    ...
    @pytest.mark.asyncio
    async def test_cleanup_expired_tokens_google_cloud_error(self, mock_firestore_client):
        """Test cleanup with Google Cloud error."""
        manager = TokenManager("test-project")
        manager._db = mock_firestore_client
        
        # Mock Firestore error
        mock_firestore_client.collection.return_value.where.side_effect = GoogleCloudError("Firestore error")
    ...
    async def test_update_token_usage_google_cloud_error(self, mock_firestore_client):
        ...
        # Mock Firestore error
        mock_firestore_client.collection.return_value.document.return_value.update.side_effect = GoogleCloudError("Firestore error")
