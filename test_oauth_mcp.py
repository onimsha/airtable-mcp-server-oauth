...
async def test_oauth_flow():
    ...
    try:
        ...
        print("Contains Airtable OAuth URL:", 'airtable.com/oauth2/v1/authorize' in auth_response)
    ...
    print()
    print("🔄 OAuth Flow:")
    print("MCP Client → oauth://authorize → Browser → Airtable → oauth_callback → Authenticated!")
